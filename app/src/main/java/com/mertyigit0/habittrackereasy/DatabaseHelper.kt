...
class DatabaseHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    override fun onCreate(db: SQLiteDatabase) {
        ...
        val CREATE_HABIT_DATA_TABLE = ("CREATE TABLE $TABLE_HABIT_DATA " +
                "($COLUMN_HABIT_DATA_ID INTEGER PRIMARY KEY AUTOINCREMENT, " +
                "$COLUMN_HABIT_DATA_HABIT_ID INTEGER, " +
                "$COLUMN_HABIT_DATA_DATE INTEGER," +
                " $COLUMN_HABIT_DATA_VALUE INTEGER, FOREIGN KEY($COLUMN_HABIT_DATA_HABIT_ID) REFERENCES " +
                "$TABLE_HABIT($COLUMN_HABIT_ID))")
